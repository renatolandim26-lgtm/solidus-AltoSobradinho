      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-24 md:h-32">
          ...
          <nav className="hidden md:flex items-center gap-8 flex-[2] justify-center">
            ...
            <a href="#galeria" className="text-foreground hover:text-primary transition-smooth font-medium">
              Galeria
            </a>
            <a href="#amenidades" className="text-foreground hover:text-primary transition-smooth font-medium">
              Lazer
            </a>
            <a href="#plantas" className="text-foreground hover:text-primary transition-smooth font-medium">
              Plantas
            </a>
            <a href="#localizacao" className="text-foreground hover:text-primary transition-smooth font-medium">
              Localização
            </a>
            <a href="#empreendimentos" className="text-foreground hover:text-primary transition-smooth font-medium">
              Empreendimentos
            </a>
